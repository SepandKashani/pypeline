...
N_FS, T_kernel = dev.bfsf_kernel_bandwidth(wl, obs_start, obs_end), FoV*2
...
print("The execution time for the script excluding the plotting of the image is: ",(datetime.datetime.now() - begin_time))
